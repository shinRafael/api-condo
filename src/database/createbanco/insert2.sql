...
-- 2 - USUARIOS
INSERT INTO Usuarios (user_nome, user_email, user_senha, user_telefone, user_tipo) VALUES
('Ana Souza', 'ana@email.com', 'senha123', '1199999999', 'Morador'),
('Carlos Pereira', 'carlos@email.com', '123456', '2198888888', 'Sindico'),
('Fernanda Lima', 'fernanda@email.com', 'abc123', '3197777777', 'ADM'),
('João Oliveira', 'joao@email.com', 'pass123', '7196666666', 'Funcionario');
...
-- 7 - VISITANTES
INSERT INTO Visitantes (vst_nome, vst_documento, ap_id, vst_data_visita, vst_data_saida) VALUES
('Pedro Alves', 'RG12345', 1, '2025-03-01 14:00:00', '2025-03-01 18:00:00'),
('Mariana Costa', 'CPF98765', 2, '2025-03-02 10:00:00', '2025-03-02 12:00:00'),
('Lucas Fernandes', 'RG56789', 3, '2025-03-03 16:30:00', '2025-03-03 20:00:00'),
('Beatriz Rocha', 'CPF123987', 4, '2025-03-04 09:00:00', '2025-03-04 11:00:00');

-- 8 - USUARIO_APARTAMENTO
